        ...
        >
            ...
            <div className="w-[340px] bg-slate-800 p-5 flex flex-col gap-4 shadow-xl z-10 border-r border-slate-700 overflow-y-auto custom-scrollbar">
                ...
                <div className="grid grid-cols-3 gap-1 bg-slate-900 p-1 rounded-lg border border-slate-700">
                    <button onClick={() => setWorkspaceMode('EDIT')} className={`py-2 rounded text-[10px] font-bold ${uiMode === 'EDIT' ? 'bg-sky-600 text-white' : 'text-slate-400 hover:bg-slate-700'}`}>Editor</button>
                    <button onClick={() => setWorkspaceMode('PREVIEW')} className={`py-2 rounded text-[10px] font-bold ${uiMode === 'PREVIEW' ? 'bg-rose-600 text-white' : 'text-slate-400 hover:bg-slate-700'}`}>Animation</button>
                    <button onClick={() => setWorkspaceMode('PLAYER_PREVIEW')} className={`py-2 rounded text-[10px] font-bold ${uiMode === 'PLAYER_PREVIEW' ? 'bg-emerald-600 text-white' : 'text-slate-400 hover:bg-slate-700'}`}>Preview</button>
                </div>
